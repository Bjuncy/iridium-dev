        ...
        <tbody>
          <tr
            ...
            <td class="iridium-table-item">
              <button class="iridium-btn iridium-btn--primary iridium-btn--smallest iridium-btn--radius" @click="handleShowImg(index)">查看</button>
            </td>
            <td class="iridium-table-item">{{ item.remark }}</td>
            <td class="iridium-table-item">
              <button class="iridium-btn iridium-btn--danger iridium-btn--smallest iridium-btn--radius" @click="deleteMessage(index)">
                <i class="glyphicon glyphicon-remove"></i>
              </button>
              <button class="iridium-btn iridium-btn--warning iridium-btn--smallest iridium-btn--radius">
